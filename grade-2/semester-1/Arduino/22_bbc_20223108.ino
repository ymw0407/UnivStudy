...
void loop() {
  ...
  if(event_dist) {
    ...
    // bang bang control
    if(dist_ema < 150.0 ) { // Replace 1 with a proper test expression using dist_target and dist_ema.
...
//  return (6762.0 / (a_value - 9) - 4.0) * 10.0 - 60;
  return 1526 - 16.2 * a_value + 0.0678 * pow(a_value, 2) - 0.000122 * pow(a_value, 3) + 0.0000000777 * pow(a_value, 4);
}
